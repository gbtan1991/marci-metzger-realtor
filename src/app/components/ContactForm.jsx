      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-block px-4 py-2 bg-muted border border-border mb-6">
            <p className="text-sm tracking-wide uppercase text-muted-foreground">Get In Touch</p>
          </div>
          <h2 
          ...
          <p className="text-lg text-muted-foreground">
            Ready to find your dream property? Reach out today for a personalized consultation
          </p>
        </div>
          ...
          <div className="bg-muted p-8 border border-border">
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="interest" className="block text-foreground mb-2">
                    I'm Interested In *
                  </label>
                  <select
                    id="interest"
